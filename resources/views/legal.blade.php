...
@section('content')
    <div class="col-12 col-md-6 col-lg-5 txt content">
        ...
        <p>Conformément aux dispositions des Articles 6-III et 19 de la Loi n°2004-575 du 21 juin 2004 pour la Confiance dans l’économie numérique, dite L.C.E.N., il est porté à la connaissance des Utilisateurs du site https://sarquentin.fr les présentes mentions légales.La connexion et la navigation sur le site (indiquer le nom du site) par l’Utilisateur implique acceptation intégrale et sans réserve des présentes mentions légales. Ces dernières sont accessibles sur le site à la rubrique « Mentions légales ».
        </p>
        <h2>ARTICLE 1 : L’éditeur</h2>
        <p>L'édition du site https://sarquentin.fr est assurée par la Société MONSIEUR SAR QUENTIN, immatriculée au RCS de Bordeaux sous le numéro 885 388 132 dont le siège social est situé au 51 rue de la Peloue, 33127 Saint Jean d'Illac, numéro de téléphone 0750976893, adresse e-mail : pro@sarquentin.fr.
